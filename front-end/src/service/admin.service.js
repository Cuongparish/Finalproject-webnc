...
const ManualMapping = (idUser, Email, Pw, FullName, DOB, Sex, Phone, StudentId) => {
  return axios
    .put(`${API_URL}/api/v1/user/ban/manualMapID`, { idUser, Email, Pw, FullName, DOB, Sex, Phone, StudentId })
    .then((res) => {
      //console.log("res: ", res);
      return res.data;
    });
...
const GetClass = () => {
  return axios
    .get(`${API_URL}/api/v1/user/ban/listClass`)
    .then((res) => {
      //console.log("res: ", res);
      return res.data;
    });
...
const ChangeStateClass = (idLop, TenLop, ChuDe, Phong, MaLop, State) => {
  return axios
    .put(`${API_URL}/api/v1/user/ban/class`, {idLop, TenLop, ChuDe, Phong, MaLop, State})
    .then((res) => {
      //console.log("res: ", res);
      return res.data;
    });
