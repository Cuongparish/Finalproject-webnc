...
import { Row, Col, Image, Tabs, Tab, InputGroup, FloatingLabel, Form, Modal, Button, Card } from "react-bootstrap";
...
const AdminManagement = (props) => {
  ...
  const user_columns = [
        ...
        },
        {
            ...
            center: true,
            width: "10%",
            selector: row =>  <InputGroup.Checkbox aria-label="checkbox" defaultChecked={row.checked} />
        },
        {
            name: "Action",
            center: true,
  ...
  const class_columns = [
        ...
        },
        {
            ...
            center: true,
            width: "10%",
            selector: row => <InputGroup.Checkbox aria-label="checkbox" defaultChecked={row.TrangThai} />
        },
  ];
    ...
    <>
        ...
        <Row className="g-0 w-100 h-100 tab-menu">
            <Tabs defaultActiveKey="info" className="border-bottom border-2 px-3">
                <Tab eventKey="info" id="info" title="User Management" className="h-100">
                    <Datatable
