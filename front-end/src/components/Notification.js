      ...
      <Dropdown.Menu style={{ width: '350px', maxHeight: '300px', overflowY: 'auto' }}>
        {haveNotification ?
          (ListNotification.map((notification, index) => (
            ...
            <Dropdown.Item style={{ height: '90px' }} className="px-0 my-1">
              <Row className="h-100 g-0 align-items-center justify-content-center px-2">
                <strong>Bạn không có thông báo nào cả !</strong>
              </Row>
            </Dropdown.Item>
          )}
      </Dropdown.Menu>
